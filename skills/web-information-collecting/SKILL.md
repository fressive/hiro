...
2. Visit the homepage to retrive some information.
3. If the information is not enough to point out a penetration orientation, check if dirsearch.csv exist in the working directory. If not,  use dirsearch tool to scan the website to retrive other valuable paths (i.e. /api, /doc, /flag, /.git, /src.zip).
...
6. Stop when you think the information collected is enough to solve the challenge.
